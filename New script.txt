-- MortyHub Script for 99 Nights in the Forest
...
-- ðŸš€ MORTYHUB LOADING SCREEN - NO BLACK BACKGROUND + REAL LOGO
-- ðŸš€ MORTYHUB LOADING SCREEN - FIXED IMAGE + TIMING
-- ðŸš€ SIMPLE LOADING SCREEN THAT WORKS
local function createLoadingScreen()
  local loadingGui = Instance.new("ScreenGui")
  loadingGui.Name = "MORTYHUBLoadingScreen"
  ...
  for i = 0, 100 do
    ...
    percentage.Text = i .. "%"
    loadingText.Text = "Loading MORTYHUB... " .. i .. "%"
...
local function DisableGodMode()
  ...
  if humanoid then
    ...
    print("ðŸ“¹ Camera restored to original character")
  end
...
local function toggleGodMode(enabled)
  print("ðŸ”„ Toggle God Mode:", enabled)
...
local function toggleInfiniteHunger(enabled)
  ...
  showNotification("ðŸ”’ Hunger frozen at " .. frozenHungerValue, 2)
else
  ...
  showNotification("ðŸ”“ Hunger unfrozen", 2)
end
end
...
if enabled then
  ...
  showNotification(" Clear Weather enabled!", 2)
else
  if WeatherConnection then
    WeatherConnection:Disconnect()
    WeatherConnection = nil
  end
  showNotification(" Weather control disabled", 2)
end
end
...
if enabled then
  ...
  showNotification("ðŸŒ«ï¸ No Fog enabled!", 2)
else
  ...
  showNotification("ðŸŒ No Fog disabled", 2)
end
end
...
print("ðŸ“¦ Storing original object settings...")
local objectCount = 0
...
print("ðŸ”§ Applying object optimizations...")
...
print("ðŸ”„ Restoring original object settings...")
...
if enabled then
  ...
  showNotification("ðŸš€ FPS Boost enabled! (Low Graphics Mode)", 2)
  ...
  showNotification("ðŸŽ¨ FPS Boost disabled! (Graphics restored)", 2)
...
if enabled then
  ...
  showNotification("ðŸŒ™ Night Vision enabled!", 2)
  ...
  showNotification("ðŸŒ… Night Vision disabled!", 2)
...
print("ðŸ”„ Updating UI with items...")
...
for itemName, count in pairs(items) do
  ...
  print("ðŸ“ Adding to UI: " .. itemName .. " (x" .. count .. ")")
end
...
print("ðŸ”„ Manual update started...")
...
for name, count in pairs(items) do
  ...
  print("ðŸ“‹ Item found: " .. name .. " (x" .. count .. ")")
end
print("ðŸ“Š Total unique items: " .. itemCount)
...
print("ðŸ”˜ Update List button clicked")
...
print("ðŸ”˜ Auto Update button clicked")
...
print("ðŸ”„ Starting initial scan...")
manualUpdateItemList(listFrame, statusLabel)
end)
...
if enabled then
  ...
  showNotification("  Always Bright enabled!", 2)
else
  ...
  showNotification("ðŸŒ… Always Bright disabled", 2)
end
end
...
if enabled then
  ...
  showNotification("ðŸŒ™ Always Night enabled!", 2)
else
  if LightingConnection then
    LightingConnection:Disconnect()
    LightingConnection = nil
  ...
  restoreOriginalLightingValues()
  showNotification("ðŸŒ› Always Night disabled", 2)
end
end
...
if enabled then
  ...
  showNotification("ðŸ”† Full HD disabled", 2)
end
end
...
print("ðŸ”„ ESP: Activating " .. espType)
...
dropdownButton.Text = "Select Targets " .. (isExpanded and "â–²" or "  ")
end)
end)
...
for i, targetName in ipairs(HitboxSystem.targets) do
  ...
  -- Close dropdown
  selectionFrame.Visible = false
  dropdownButton.Text = dropdownButton.Text:gsub("â–²", "  ")
  end)
  end)
end
...
isExpanded = not isExpanded
selectionFrame.Visible = isExpanded
dropdownButton.Text = dropdownButton.Text:gsub(isExpanded and "  " or "â–²", isExpanded and "â–²" or "  ")
end)
end)
...
print("ðŸ§ª ESP Test: Looking for " .. (targetName or "Bunny"))
end,
...
-- Create ScreenGui
MORTYHUBGui = Instance.new("ScreenGui")
MORTYHUBGui.Name = "MORTYHUBGui"
MORTYHUBGui.Parent = PlayerGui
MORTYHUBGui.ResetOnSpawn = false
MORTYHUBGui.IgnoreGuiInset = true

-- Main Frame (mulai dari posisi tersembunyi)
MainFrame = Instance.new("Frame")
MainFrame.Name = "MainFrame"
MainFrame.Parent = MORTYHUBGui
...
notification.Parent = MORTYHUBGui
...
farmInfoLabel.Text = "ðŸŒ³ Trees: 0 |  … Chopped: 0"
...
if farmInfoLabel and farmInfoLabel.Parent then
  ...
  farmInfoLabel.Text = string.format("ðŸŒ³ Trees: %d |  … Chopped: %d", treeCount, TreesChopped)
end
end
end
)
...
local function findItemForTeleport(itemName)
    ...
    print("ðŸ“Š Total found for teleport:", #foundItems)
    return foundItems
end
...
-- ðŸŸ© Kolom kiri (sama seperti sebelumnya)
...
-- ðŸŸ¦ Kolom kanan - DENGAN TELEPORT BARU
...
if isExpanded then
  dropdownButton.Text = "Select Chest â–²"
...
bringUIButton.MouseButton1Click:Connect(function()
    ...
    spawn(function()
        pcall(function()
            loadstring(game:HttpGet("https://raw.githubusercontent.com/Clavv889/script/refs/heads/main/sapl"))()
...
descLabel.Text =
"Professional script for 99 Nights in the ForestnnFeatures: Advanced movement system   Item management   ESP system   Player utilities   Mobile optimized"
...
creditsLabel.Text =
"Created by: MORTYHUB TeamnVersion: 1.0.0nGame: 99 Nights in the ForestnOptimized for mobile devices"
...
contactLabel.Text = "Contact: tiktok:MORTYHUB "
...
disclaimerLabel.Text = "Disclaimer: This script is for personal use and entertainment only. Use responsibly. Excessive use may cause lag, crashes, or unwanted effects. Developer is not responsible for any issues, bans, or consequences."
...
spawn(function()
wait(0.5)
typewriterEffect(welcomeLabel, "Welcome, " .. Player.Name .. " ðŸ‘‹", 0.05)
end)
...
-- ðŸŽ¯ ENHANCED HIDE ANIMATION (Yang ditingkatkan)
...
print("¯ MORTYHUB Main GUI Starting...")
-- Initial GUI setup
setupGui()
...
showNotification("MORTYHUB Ready - Features will persist!", 3)
task.spawn(
function()
local player = game.Players.LocalPlayer
local playerGui = player:WaitForChild("PlayerGui")
...
function()
local gui = playerGui:FindFirstChild("MORTYHUBGui")
if gui then
